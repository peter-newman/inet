...
.. _sec:authorsguide:guidelines:

Guidelines
----------

.. _sec:authorsguide:do-not-repeat-the-standard:
...
.. _sec:authorsguide:do-not-repeat-ned:
...
.. _sec:authorsguide:no-cplusplus:
...
.. _sec:authorsguide:keep-examples-short:
...
.. _sec:authorsguide:no-reference-to-simulation-examples:
