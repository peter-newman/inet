.. _cha:network-interfaces:

Network Interfaces
==================

.. _sec:interfaces:overview:
...
.. _sec:interfaces:built-in-network-interfaces:
...
.. _sec:interfaces:anatomy-of-network-interfaces:
...
.. _sec:interfaces:internal-vs-external-output-queue:
...
.. _sec:interfaces:traffic-conditioners:
...
.. _sec:interfaces:the-interface-table:
...
.. _sec:interfaces:wired-network-interfaces:
...
.. _sec:interfaces:wireless-network-interfaces:
...
.. _sec:interfaces:generic-wireless-interface:
...
.. _sec:interfaces:wireless-sensor-networks:
...
.. _sec:interfaces:special-purpose-network-interfaces:

Special-Purpose Network Interfaces
----------------------------------

.. _sec:interfaces:tunnelling:
...
.. _sec:interfaces:local-loopback:
...
.. _sec:interfaces:external-interface:
...
.. _sec:interfaces:custom-network-interfaces:
